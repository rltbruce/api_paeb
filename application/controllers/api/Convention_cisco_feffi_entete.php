...
class Convention_cisco_feffi_entete extends REST_Controller {
    ...
    public function index_get() 
    {
        ...
        elseif ($menu=='getconventionvalideufpBydateutilisateur') //mande       
        {
            ...
            $tmp = $this->Convention_cisco_feffi_enteteManager->findconventionvalideufpBydateutilisateur($this->generer_requete($date_debut,$date_fin,$id_region,$id_cisco,$id_commune,$id_ecole,$id_convention_entete,$lot),$id_utilisateur);
            if ($tmp) 
            {
                foreach ($tmp as $key => $value) 
                {
