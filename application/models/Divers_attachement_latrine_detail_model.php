...
class Divers_attachement_latrine_detail_model extends CI_Model {
    protected $table = 'divers_attachement_latrine_detail';
    ...
    public function _set($attachement) {
        return array(
            ...
            'id_attachement_latrine'    => $attachement['id_attachement_latrine']                      
        );
    }
    ...
    public function getdetailbyattachement_latrine($id_attachement_latrine) {               
        $result =  $this->db->select('*')
                        ->from($this->table)
