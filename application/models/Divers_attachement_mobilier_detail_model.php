...
class Divers_attachement_mobilier_detail_model extends CI_Model {
    protected $table = 'divers_attachement_mobilier_detail';
    ...
    public function _set($attachement) {
        return array(
            ...
            'id_attachement_mobilier'    => $attachement['id_attachement_mobilier']                      
        );
    }
    ...
    public function getdetailbyattachement_mobilier($id_attachement_mobilier) {               
        $result =  $this->db->select('*')
                        ->from($this->table)
