...
class Divers_attachement_batiment_prevu_model extends CI_Model {
    ...
    public function _set($attachement) {
        return array(
            ...
            'id_divers_attachement_batiment'    => $attachement['id_divers_attachement_batiment']                       
        );
    }
    ...
    public function findByIdlibelle($id)  {
        $this->db->select("divers_attachement_batiment_prevu.*, divers_attachement_batiment.libelle as libelle");
        $this->db->join("divers_attachement_batiment", 'divers_attachement_batiment.id=divers_attachement_batiment_prevu.id_divers_attachement_batiment');
